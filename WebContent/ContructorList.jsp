...
<%!ArrayList<PersonModel> listPerson;
String sql=null;
	...
	sql=WebProjectLIstUtils.getQueryForAdminRole(model.getRoleId(), "3", model.getDistricId(), model.getState_RegionId(), model.getRegionId());
	%>
...
$(document).ready(
	...
	function populate(values) {
		$.ajax({
			...
			data : '&ProfessionId=3' + '&BasedOn=' + values,
				...
				<tbody id="data_come">
					...
					<tr
						...
						<td align="center"
							...
							class="text-danger" <%} else {%> class="text-primary" <%}%>><%=listPerson.get(i).getStatus()%>
						</td>
						<td align="center">
						...
						<td align="center">
							<%-- 							 <input type="button"  value="Delete User" class="del"  data-string=<%=listPerson.get(i).getId()%>>
