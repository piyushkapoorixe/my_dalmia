...
String sql =null;
	...
	sql=WebProjectLIstUtils.getQueryForAdminRole(model.getRoleId(), "1", model.getDistricId(), model.getState_RegionId(), model.getRegionId());
	%>
...
$(document).ready(
	...
	function populate(values) {
		$.ajax({
			...
			data : '&ProfessionId=1' + '&BasedOn=' + values,
	...
	/* $(document).ready(function() {
		$(".del").click(function() {
			//e.preventDefault();
			var del_var = $(this).attr('data-string');
			//alert(del_var);
