...
<%!ArrayList<PersonModel> listPerson = null;
   String sql=null;
	...
	sql=WebProjectLIstUtils.getQueryForAdminRole(model.getRoleId(), "2", model.getDistricId(), model.getState_RegionId(), model.getRegionId());
	%>
...
$(document).ready(
	...
	function populate(values) {
		$.ajax({
			...
			data : 'ProfessionId=2' + '&BasedOn=' + values,
			...
			<table id="example" class="display table table-bordered">
				...
				<tbody id="data_come">
					...
					<tr
						...
						<td align="center">
							<%-- 							 <input type="submit"  value="Delete User" class="del"  data-string=<%=listPerson.get(i).getId()%>>
